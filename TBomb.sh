...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mSmitraj \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border RAJ
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           WEBSITE : techsmit12.blogspot.com \e[0m"
    echo -e "\e[4;32m   YouTube: https://youtube.com/channel/UChwd0IfIihSZdigXLeakAwA \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of TEC-X for more stability."
    echo " "
}
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By SMITRAJ > .update
